    ...
    return (
        <section className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 my-12 lg:my-16 relative items-center" id="about-section">
            ...
            <div className="flex-col">
                <p className="font-medium mb-5 text-[#16f2b3] text-xl uppercase">{t('home.aboutSection.title')}</p>
                <p className="text-gray-200 text-sm lg:text-lg">{t('home.aboutSection.description')}</p>
            </div>
