                ...
                <div className="flex gap-[2.8125rem]">
                    ...
                    <form className="flex flex-col w-[90vw] md:w-[50vw] gap-[2.4375rem] justify-center items-center md:items-stretch" onSubmit={handleSubmit(contactSubmit)} id="contactForm">
                        <div className="relative">
                            <input type="text" id="name_input" className="px-3.5 pb-2.5 pt-6 w-[90vw] md:w-full text-xl text-[rgba(73,_73,_73,_1)] bg-white rounded-lg border-[0.125rem] border-[rgba(208,_214,_221,_1)] appearance-none focus:outline-none focus:ring-0 peer" placeholder=" " {...register("name")}/>
                        ...
                        <div className="relative">
                            <input type="text" id="email_input" className="px-3.5 pb-2.5 pt-6 w-[90vw] md:w-full text-xl text-[rgba(73,_73,_73,_1)] bg-white rounded-lg border-[0.125rem] border-[rgba(208,_214,_221,_1)] appearance-none focus:outline-none focus:ring-0 peer" placeholder=" " {...register("email")}/>
                        ...
                        <div className="relative">
                            <textarea rows={window.innerWidth <= 768 ? 4 : 10} id="message_input" className="px-3.5 pb-2.5 pt-6 w-[90vw] md:w-full text-xl text-[rgba(73,_73,_73,_1)] bg-white rounded-lg border-[0.125rem] border-[rgba(208,_214,_221,_1)] appearance-none focus:outline-none focus:ring-0 peer resize-none" placeholder=" " {...register("message")}/>
                        ...
                        <button className="flex items-center gap-3 rounded-full bg-gradient-to-r from-pink-500 to-violet-600 px-5 md:px-12 py-2.5 md:py-3 text-center text-xs md:text-sm font-medium uppercase tracking-wider text-white no-underline hover:text-white hover:no-underline md:font-semibold w-fit hover:opacity-[.9]">
